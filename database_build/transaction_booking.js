...
async function main() {
    ...
    try {
        ...
        var flight_nos = [7437]; //this will be 'input' by the user by them selecting a viable flight after they specify the whens and wheres
        var economySeats = 1;
        var businessSeats = 0;
        var discount_code = "none";
        var card_no = "1594789622331515";

        // we will do 3 passengers so passengersInfo.length==3
        var passengersInfo = [
            //[passport_no, first_name, last_name, email_address, phone_no, dob, seatClass]
            ["588970267","Shepherd","Aggio","saggio0@edublogs.org","552-967-7436","1993-04-26","economy"]
        ];
