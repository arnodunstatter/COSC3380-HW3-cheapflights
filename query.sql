--The following sql statements are part of the query for loginDisplayTickets(client, melikanass@gmail.com)SELECT t.ticket_no, 
        f.flight_no, 
        plane.aircraft_code, 
        plane.aircraft_name, 
        p.passport_no, 
...
WHERE email_address = 'melikanass@gmail.com';SELECT *
FROM boarding_passes
WHERE ticket_no = 246;--The following sql statements are part of the query for for getBoardingPass(client,246)SELECT *
FROM boarding_passes
WHERE ticket_no = 247;--The following sql statements are part of the query for for getBoardingPass(client,247)SELECT *
FROM boarding_passes
WHERE ticket_no = 248;--The following sql statements are part of the query for for getBoardingPass(client,248)SELECT *
FROM boarding_passes
WHERE ticket_no = 246;--The following sql statements are part of the query for for getBoardingPass(client,246)SELECT *
FROM boarding_passes
WHERE ticket_no = 247;--The following sql statements are part of the query for for getBoardingPass(client,247)SELECT *
